  ...
  const services = [
    {
      ...
      description: 'Keep track of laboratory equipment, maintenance schedules, and usage history.',
      borderColor: '#1976d2', 
    },
    {
      title: 'Experiment Tracking',
      description: 'Log and analyze experiment data, set up protocols, and record results.',
      borderColor: '#4caf50',
    },
    {
      title: 'Sample Management',
      description: 'Organize and catalog samples, manage storage, and retrieve data quickly.',
      borderColor: '#ff9800', 
    },
    {
      title: 'Data Analysis',
    ...
    },
    {
      ...
      description: 'Collaborate with other labs and researchers for breakthrough discoveries.',
      borderColor: '#f44336', 
    },
  ];
   ...
   <div style={root}>
      <Grid container spacing={4}>
        {doctors.map((doctor, index) => (
          <Grid item key={index} xs={12} sm={6} md={4}>
            <Card sx={card}>
              <CardContent sx={cardContent}>
                <img src={doctor.picture} alt={doctor.name} height={350} width='100%' sx={{height:'300px'}} />
                <Typography variant="h6" component="h2">
                  {doctor.name}
                </Typography>
                <Typography variant="body2" color="textSecondary">
    ...
    <Typography variant="h4" sx={headingStyle} color='primary'>        
     ...
     <div className={contectHeading}>
      ...
      Get in touch with our laboratory experts for comprehensive and  cutting-edge
      </Typography>
      <Typography variant="h5" component="h1" align="center">
